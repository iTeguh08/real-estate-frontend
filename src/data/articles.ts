...
export const ARTICLES: Article[] = [
  ...
  {
    id: 'a2',
    slug: 'millennial-homeowners-inflation',
  ...
  {
    id: 'a3',
    slug: 'choose-right-neighborhood',
  ...
  {
    id: 'a5',
    slug: 'staging-secrets-sell-faster',
  ...
  {
    id: 'a6',
    slug: 'luxury-rentals-gateway-cities',
...
export const ARTICLE_PREVIEW_COUNT = 3;
