  ...
  return (
    <main id="main-content" className="section-container py-16">
      ...
      <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,320px)_1fr]">
        <Skeleton className="aspect-[4/5] w-full max-w-md rounded-hz" />
        <div className="space-y-4">
          <Skeleton className="h-8 w-48 rounded-hz" />
          <Skeleton className="h-4 w-32 rounded-hz" />
          <Skeleton className="h-20 w-full rounded-hz" />
          <div className="flex gap-3">
            <Skeleton className="h-10 w-32 rounded-hz" />
            <Skeleton className="h-10 w-32 rounded-hz" />
          </div>
        </div>
      </div>
      ...
      <section className="mt-16">
        <Skeleton className="h-6 w-48 rounded-hz" />
